...
Addendum
The Artificial Life Ethics Committee has submitted a petition opposing the development of artificial lifeforms capable of advanced pseudo-emotional behavior.
Following a review of the project's security protocols, it is recommended that the CosmOS Development Program be redesignated as a classified program, with all subsequent research and development conducted under restricted access.
...
機能
・演算処理系には■■社製CALCv2-COREを採用。また、疑似生態・行動制御には独自開発の模倣演算機IDEA-COREを搭載
・多様な惑星環境への適応性向上を目的として、疑似生態ハードウェアには複数の惑星外生命体由来の遺伝情報を一部導入している。

課題
・現時点における試験開発個体では重大な機能障害は確認されていない。しかし、CALCv2-COREとIDEA-COREの演算特性が相互に競合することにより、高度な合理的判断能力と安定した疑似感情表現を両立する個体の開発は極めて困難であることが判明した。
・IDEA-COREの動作に起因し、一部個体において自己存在認識に関する葛藤に類似した疑似感情反応が確認されている。該当反応は人工的に生成されたものであるが、長期運用時には任務遂行能力へ重大な影響を及ぼす可能性が否定できない。このため、CALCv2-COREとIDEA-COREを並列運用する場合には、状況に応じていずれか一方の演算機能を制限することが望ましいと判断する。

追記
人工生命倫理委員会より、高度な疑似感情を有する人工生命体の開発に対する反対意見及び署名が提出された。
これを受け、本計画に関する情報管理体制を再検討した結果、CosmOS開発計画を機密指定プロジェクトへ移行することを要請する。
